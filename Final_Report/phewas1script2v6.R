...
rs4077469_T_data0 = left_join(gdata3, phenotypes,  by="id")
...
write.csv(table_1, file = "Table1_final_rs4077469_T.csv")
...
table1 = CreateTableOne(vars = variables_names
               ...
               , strata = "SEX")
table_1 = print(table1, showAllLevels = T)
write.csv(table_1, file = "Table1_final_rs4077469_T_gender.csv")
...
table1 = CreateTableOne(vars = variables_names
                        ...
                        , strata = "rs4077469_T")
table_1 = print(table1, showAllLevels = T)
write.csv(table_1, file = "Table1_final_rs4077469_T_bySNP.csv")
...
table1 = CreateTableOne(vars = variables_names
                        ...
                        , strata = c("218.1", "SEX"))
table_1 = print(table1, showAllLevels = T)
write.csv(table_1, file = "Table1_final_rs4077469_T_gender_Uterine_leiomyoma.csv")
...
table1 = CreateTableOne(vars = variables_names
                        ...
                        , strata = c("218", "SEX"))
table_1 = print(table1, showAllLevels = T)
write.csv(table_1, file = "Table1_final_rs4077469_T_gender_BenignNeoplasm_of_Uterus.csv")

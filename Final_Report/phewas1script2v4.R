...
covariates = covariates_age_gender
covariates[1:10,]
...
rs4077469_T_data_table = select(rs4077469_T_data, '218.1', '218', age, SEX, rs4077469_T)
rs4077469_T_data_table[1:10, 1:10]
...
#Plot the results
pdf("phewasplot_rs4077469_gender_age.pdf")
phewasManhattan(results, annotate.angle=0,
                title="Manhattan Plot for rs4077469 with Gender & Age")
dev.off()
...
write.table(results_d, "phewasresults_rs4077469_gender_age.tsv"
            ,quote = F, row.names = F
            , col.names = T, sep = "\t")
